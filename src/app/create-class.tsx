    ...
    <View className="flex-1 bg-dark">
      ...
      <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row justify-between items-center mb-2">
          ...
          <View className="bg-dark-card px-2 py-1 rounded border border-dark-border">
        ...
        <Card className="border-2 border-dashed border-dark-border p-8 items-center gap-3 mb-4">
          <View className="w-16 h-16 rounded-full bg-dark justify-center items-center">
            {loading ? (
        ...
        <Text className="text-center text-sm font-semibold text-gray-500 mb-4">OR</Text>

        <Card className="flex-row items-center gap-3 p-4 mb-4">
          <View className="w-12 h-12 rounded-full bg-dark justify-center items-center">
          ...
          <View className="flex-1">
            ...
            <Text className="text-xs text-gray-500">Input student details individually</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color="#64748B" />
        </Card>

        <Card className="flex-row gap-3 p-4 border border-primary mb-6">
          <Ionicons name="information-circle" size={20} color="#0EA5E9" />
          <Text className="flex-1 text-xs text-gray-400 leading-relaxed">
